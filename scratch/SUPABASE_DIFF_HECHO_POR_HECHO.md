# Diff Supabase vs HECHOS_DEMANDA_PARETOMED_2026

- Proyecto Supabase objetivo: `bqigfoolbrrwpuqafxst`
- URL esperada: `https://bqigfoolbrrwpuqafxst.supabase.co`
- Documento fuente: `HECHOS_DEMANDA_PARETOMED_2026.md`
- Snapshot auditado: `paretomed-evidencia\scratch\supabase_snapshot.json`
- Hechos totales: `67`
- Resumenes a corregir: `0`
- Pruebas a corregir: `0`
- Hechos sin cambios: `67`
...
- Pruebas actuales: `P-21`
- Pruebas correctas: `P-21`
...
- Pruebas actuales: `P-20`
- Pruebas correctas: `P-20`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas actuales: `P-20, P-27, P-28`
- Pruebas correctas: `P-20, P-27, P-28`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas actuales: `P-11`
- Pruebas correctas: `P-11`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas actuales: `P-14, P-20`
- Pruebas correctas: `P-14, P-20`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas actuales: `P-08, P-14`
- Pruebas correctas: `P-08, P-14`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas actuales: `P-25, P-26`
- Pruebas correctas: `P-25, P-26`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas actuales: `P-27`
- Pruebas correctas: `P-27`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas actuales: `P-28, P-29, P-30, P-31, P-32`
- Pruebas correctas: `P-28, P-29, P-30, P-31, P-32`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas actuales: `P-02, P-03, P-04, P-39`
- Pruebas correctas: `P-02, P-03, P-04, P-39`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas actuales: `P-02, P-04`
- Pruebas correctas: `P-02, P-04`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas actuales: `P-22, P-23`
- Pruebas correctas: `P-22, P-23`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas actuales: `P-02, P-03, P-33, P-34`
- Pruebas correctas: `P-02, P-03, P-33, P-34`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `215` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `221` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Duración: 16 meses de sociedad de hecho`
- Resumen actual: `La sociedad de hecho opero por aproximadamente **16 meses**: desde el 15 de abril de 2024 (fecha en que Pedro recordo a Oscar el inicio de los pagos y solicitaron definir presupuesto de publicidad) hasta el 28 de agosto de 2025 (fecha en que Oscar ac...`
- Resumen correcto: `La sociedad de hecho opero por aproximadamente **16 meses**: desde el 15 de abril de 2024 (fecha en que Pedro recordo a Oscar el inicio de los pagos y solicitaron definir presupuesto de publicidad) hasta el 28 de agosto de 2025 (fecha en que Oscar ac...`
- Pruebas actuales: `P-02`
- Pruebas correctas: `P-02`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `229` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Pedro presiona reiteradamente para formalizar`
- Resumen actual: `Pedro presiono reiteradamente para formalizar la sociedad: (a) el 15 de julio de 2024, Pedro solicito el borrador del acuerdo; (b) el 28 de noviembre de 2024, Pedro solicito firmar y Oscar pidio tiempo porque su padre (abogado) estaba revisando: *"no...`
- Resumen correcto: `Pedro presiono reiteradamente para formalizar la sociedad: (a) el 15 de julio de 2024, Pedro solicito el borrador del acuerdo; (b) el 28 de noviembre de 2024, Pedro solicito firmar y Oscar pidio tiempo porque su padre (abogado) estaba revisando: *"no...`
- Pruebas actuales: `P-02`
- Pruebas correctas: `P-02`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `235` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Alteración documental — "acciones" por "utilidades"`
- Resumen actual: `Aproximadamente 10 dias antes del 14 de agosto de 2025, un "usuario anonimo" modifico el borrador del acuerdo de socios en Google Docs, reemplazando la palabra **"acciones"** por **"utilidades"**. Pedro descubrio el cambio mediante el historial de ve...`
- Resumen correcto: `Aproximadamente 10 dias antes del 14 de agosto de 2025, un "usuario anonimo" modifico el borrador del acuerdo de socios en Google Docs, reemplazando la palabra **"acciones"** por **"utilidades"**. Pedro descubrio el cambio mediante el historial de ve...`
- Pruebas actuales: `P-02, P-06, P-07`
- Pruebas correctas: `P-02, P-06, P-07`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `239` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Contrato de Cuentas en Participación niega sociedad`
- Resumen actual: `El 22 de agosto de 2025, Oscar entrego un **Contrato de Cuentas en Participacion** (nunca firmado) en el que intenta reclasificar a Pedro como "Socio Oculto" y a si mismo como "Socio Gestor". El contrato incluye una clausula que niega expresamente la...`
- Resumen correcto: `El 22 de agosto de 2025, Oscar entrego un **Contrato de Cuentas en Participacion** (nunca firmado) en el que intenta reclasificar a Pedro como "Socio Oculto" y a si mismo como "Socio Gestor". El contrato incluye una clausula que niega expresamente la...`
- Pruebas actuales: `P-14`
- Pruebas correctas: `P-14`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `245` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Ruptura — 14 de agosto de 2025`
- Resumen actual: `El 14 de agosto de 2025, tras descubrir la alteracion documental, Pedro propuso terminar la relacion por perdida de confianza. En la misma fecha, durante la grabacion de llamada telefonica, Oscar hizo las admisiones consignadas en los hechos vigesimo...`
- Resumen correcto: `El 14 de agosto de 2025, tras descubrir la alteracion documental, Pedro propuso terminar la relacion por perdida de confianza. En la misma fecha, durante la grabacion de llamada telefonica, Oscar hizo las admisiones consignadas en los hechos vigesimo...`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `247` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Notificación formal de cese de explotación`
- Resumen actual: `El 28 de agosto de 2025, Oscar acepto formalmente la terminacion de la relacion. El 29 de agosto de 2025, Pedro envio la **Notificacion Formal de Cese de Explotacion**, solicitando a Oscar *"se abstenga de continuar con la explotacion de los activos ...`
- Resumen correcto: `El 28 de agosto de 2025, Oscar acepto formalmente la terminacion de la relacion. El 29 de agosto de 2025, Pedro envio la **Notificacion Formal de Cese de Explotacion**, solicitando a Oscar *"se abstenga de continuar con la explotacion de los activos ...`
- Pruebas actuales: `P-02, P-18`
- Pruebas correctas: `P-02, P-18`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `253` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Oferta de Oscar — $40M por renunciar a todo`
- Resumen actual: `Aproximadamente el 12 de septiembre de 2025, Oscar presento una propuesta de **Contrato de Transaccion** en la que ofrecio $40.000.000 COP como "suma transaccional", declaro la inexistencia de sociedad de hecho, exigio que toda la propiedad intelectu...`
- Resumen correcto: `Aproximadamente el 12 de septiembre de 2025, Oscar presento una propuesta de **Contrato de Transaccion** en la que ofrecio $40.000.000 COP como "suma transaccional", declaro la inexistencia de sociedad de hecho, exigio que toda la propiedad intelectu...`
- Pruebas actuales: `P-15`
- Pruebas correctas: `P-15`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `255` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Contrapropuesta de Pedro — $300M`
- Resumen actual: `El 14 de octubre de 2025, Pedro, a traves de DOCTOR FLIGHT S.A.S., envio una **contrapropuesta de transaccion** por **$300.000.000 COP** ($270M + $30M de facturas pendientes de agosto-octubre 2025). Esta contrapropuesta reconocia en su Consideracion ...`
- Resumen correcto: `El 14 de octubre de 2025, Pedro, a traves de DOCTOR FLIGHT S.A.S., envio una **contrapropuesta de transaccion** por **$300.000.000 COP** ($270M + $30M de facturas pendientes de agosto-octubre 2025). Esta contrapropuesta reconocia en su Consideracion ...`
- Pruebas actuales: `P-16`
- Pruebas correctas: `P-16`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `257` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Fracaso de negociación transaccional`
- Resumen actual: `Las partes no lograron acuerdo alguno. La diferencia entre las ofertas evidencia la brecha: Oscar ofrecio $40M (3.3% del patrimonio estimado de $1,200M), mientras Pedro pretendia $300M (25%). **[P-15, P-16, P-17]**`
- Resumen correcto: `Las partes no lograron acuerdo alguno. La diferencia entre las ofertas evidencia la brecha: Oscar ofrecio $40M (3.3% del patrimonio estimado de $1,200M), mientras Pedro pretendia $300M (25%). **[P-15, P-16, P-17]**`
- Pruebas actuales: `P-15, P-16, P-17`
- Pruebas correctas: `P-15, P-16, P-17`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `263` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `NETMED S.A.S. — vehículo post-ruptura de Oscar`
- Resumen actual: `El 15 de octubre de 2025, Oscar constituyo unilateralmente la sociedad **NETMED S.A.S.** por documento privado en Barranquilla, inscrita en la Camara de Comercio el 30 de octubre de 2025. Oscar es propietario del 100% de las acciones. En la grabacion...`
- Resumen correcto: `El 15 de octubre de 2025, Oscar constituyo unilateralmente la sociedad **NETMED S.A.S.** por documento privado en Barranquilla, inscrita en la Camara de Comercio el 30 de octubre de 2025. Oscar es propietario del 100% de las acciones. En la grabacion...`
- Pruebas actuales: `P-01, P-24`
- Pruebas correctas: `P-01, P-24`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `265` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Renovación unilateral de matrícula mercantil`
- Resumen actual: `Oscar renovo la matricula del establecimiento comercial PARETOMED el 9 de agosto de 2025, estando la sociedad de hecho en plena crisis, sin consultar ni informar a Pedro. Segun certificado de Camara de Comercio, ParetoMed declara activos vinculados d...`
- Resumen correcto: `Oscar renovo la matricula del establecimiento comercial PARETOMED el 9 de agosto de 2025, estando la sociedad de hecho en plena crisis, sin consultar ni informar a Pedro. Segun certificado de Camara de Comercio, ParetoMed declara activos vinculados d...`
- Pruebas actuales: `P-20`
- Pruebas correctas: `P-20`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `271` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Solicitud de conciliación extrajudicial`
- Resumen actual: `El 11 de febrero de 2026, se radico solicitud de conciliacion N 013-2026 ante el Centro de Conciliacion de la Corporacion Lonja de Propiedad Raiz de Barranquilla. **[P-19]**`
- Resumen correcto: `El 11 de febrero de 2026, se radico solicitud de conciliacion N 013-2026 ante el Centro de Conciliacion de la Corporacion Lonja de Propiedad Raiz de Barranquilla. **[P-19]**`
- Pruebas actuales: `P-19`
- Pruebas correctas: `P-19`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `273` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Constancia de no conciliación — vía judicial expedita`
- Resumen actual: `El 20 de febrero de 2026, se expidio la **CONSTANCIA DE NO CONCILIACION N 00-1844**. El Conciliador Francisco Daniel Ramirez Carreno (CC 19.334.946, T.P. 30.770) dejo constancia de que las partes no llegaron a acuerdo. Las pretensiones presentadas in...`
- Resumen correcto: `El 20 de febrero de 2026, se expidio la **CONSTANCIA DE NO CONCILIACION N 00-1844**. El Conciliador Francisco Daniel Ramirez Carreno (CC 19.334.946, T.P. 30.770) dejo constancia de que las partes no llegaron a acuerdo. Las pretensiones presentadas in...`
- Pruebas actuales: `P-19`
- Pruebas correctas: `P-19`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `279` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Valoración del patrimonio — $1,200M estimados`
- Resumen actual: `Segun el Anexo de Valoracion elaborado en agosto de 2025, el patrimonio de PARETOMED se estima en $1.200.000.000 COP, compuesto por: (a) fondo de comercio y proyeccion de ingresos: $905.000.000 (basado en proyeccion de 19 meses a $47.267.338/mes); (b...`
- Resumen correcto: `Segun el Anexo de Valoracion elaborado en agosto de 2025, el patrimonio de PARETOMED se estima en $1.200.000.000 COP, compuesto por: (a) fondo de comercio y proyeccion de ingresos: $905.000.000 (basado en proyeccion de 19 meses a $47.267.338/mes); (b...`
- Pruebas actuales: `P-17`
- Pruebas correctas: `P-17`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `281` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Participación de Pedro — 20% = $240M`
- Resumen actual: `La participacion del 20% de Pedro en el patrimonio estimado asciende a **$240.000.000 COP**. Esta cifra es congruente con tres valoraciones realizadas por el demandante y sus asesores: (a) $240M por Anexo de Valoracion para liquidacion de sociedad; (...`
- Resumen correcto: `La participacion del 20% de Pedro en el patrimonio estimado asciende a **$240.000.000 COP**. Esta cifra es congruente con tres valoraciones realizadas por el demandante y sus asesores: (a) $240M por Anexo de Valoracion para liquidacion de sociedad; (...`
- Pruebas actuales: `P-16, P-17, P-35`
- Pruebas correctas: `P-16, P-17, P-35`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `283` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Utilidades post-ruptura no pagadas a Pedro`
- Resumen actual: `Segun las transferencias bancarias documentadas, Pedro recibio pagos hasta julio de 2025 (transferencia del 05/08/2025 por $7.450.000, que cubria el mes de julio). Oscar continuo explotando PARETOMED de manera unilateral despues de la ruptura y **sig...`
- Resumen correcto: `Segun las transferencias bancarias documentadas, Pedro recibio pagos hasta julio de 2025 (transferencia del 05/08/2025 por $7.450.000, que cubria el mes de julio). Oscar continuo explotando PARETOMED de manera unilateral despues de la ruptura y **sig...`
- Pruebas actuales: `P-16, P-18, P-36, P-37, P-43`
- Pruebas correctas: `P-16, P-18, P-36, P-37, P-43`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Estado: `SIN CAMBIOS`
- Documento: linea `329` del archivo `HECHOS_DEMANDA_PARETOMED_2026.md`
- Titulo actual en Supabase: `Aporte de infraestructura CRM`
- Resumen actual: `Pedro participaba activamente en la **co-determinacion de los precios** del programa ParetoMed, funcion estrategica reservada a socios o directivos. Se acreditan al menos tres instancias documentadas: (a) el 21 de marzo de 2025, Pedro propuso una est...`
- Resumen correcto: `Pedro participaba activamente en la **co-determinacion de los precios** del programa ParetoMed, funcion estrategica reservada a socios o directivos. Se acreditan al menos tres instancias documentadas: (a) el 21 de marzo de 2025, Pedro propuso una est...`
- Pruebas actuales: `P-02, P-03, P-05, P-40`
- Pruebas correctas: `P-02, P-03, P-05, P-40`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas correctas: `P-02, P-03, P-25, P-26, P-27`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas correctas: `P-02, P-03, P-39`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
...
- Pruebas correctas: `P-02, P-08, P-15`
- Agregar pruebas: `(ninguna)`
- Quitar pruebas: `(ninguna)`
